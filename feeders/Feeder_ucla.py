# modified from https://github.com/Uason-Chen/CTR-GCN
import numpy as np
import pickle
import json
import random
...
class Feeder(Dataset):
    def __init__(self, split, data_path='E:/DataSets/all_sqe/', repeat=1, random_choose=False,
                 random_shift=False, random_move=False,
                 window_size=-1, normalization=False, debug=False, use_mmap=True, vel = False, bone = False):
        ...
        # self.data_path = 'data/NW-UCLA/all_sqe/'  # change
        self.data_path = data_path  # change
        self.vel = vel
        self.b = bone
        self.time_steps = 52
    ...
    def load_data(self):
        ...
        for data in self.data_dict:
            ...
            with open(self.data_path + file_name + '.json', 'r') as f:
