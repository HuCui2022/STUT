...
test_txt_path = 'E:/DataSets/SHREC2017/test_gestures.txt'
...
for i in range(Samples_sum): # 遍历每一个样本
    ...
    if not os.path.exists(root_database_path + "/shrec17_jsons/test_jsons/"):
        os.makedirs(root_database_path + "/shrec17_jsons/test_jsons/")
    with open(root_database_path + "/shrec17_jsons/test_jsons/" + file_name + ".json", 'w') as f:
...
with open(root_database_path + "/shrec17_jsons/" + "test_samples.json", 'w') as t: # 将所有样本的信息保存为一个json格式文件
